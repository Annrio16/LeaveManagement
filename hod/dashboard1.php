...
<body>
	...
	<header id="main-header" class="bg-danger py-2 text-white">
		<div class="container">
			<div class="row">
				<div class="col-md-6">
					<h1><i class="fa fa-user-secret"></i> HOD Panel</h1>
				</div>
			</div>
		</div>
	</header>
	...
	<section id="sections" class="py-4 mb-4 bg-faded">
		<div class="container">
			<div class="row">
				...
				<div class="col-md-2">
					<a href="#" class="btn btn-primary btn-block" style="margin-left:-280%;border-radius:0%;" data-toggle="modal" data-target="#addUsertModal"><i class="fa fa-th"></i> Total Leaves</a>
				</div>
				<!-- <div class="col-md-2">
									...
									<td><?php echo $cnt;?></td>
							 		...
							 		<td>
							 			<form action="accept.php?id=<?php echo $result['id']; ?>" method="POST">
											...
											<input type="submit" class="btn btn-sm btn-success" name="decline" value="Decline">
